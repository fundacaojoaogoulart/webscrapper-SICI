        ...
        while True:
            ...
            if nivel == 1:
                ...
                if not is_orgao_tipo_a:
                    ...
                    resultados.append({"órgão": orgao_atual, "escalão": "1º", "área": area1, "cargo": cargo1})
            ...
            if nivel == 2:
                if processando_ramo:
                    ...
                    resultados.append({"órgão": orgao_atual, "escalão": escalao_n2, "área": area2, "cargo": cargo2})
                i += 1
                continue
            ...
            if nivel == 3:
                if processando_ramo:
                    if is_orgao_tipo_a:
                        ...
                        resultados.append({"órgão": orgao_atual, "escalão": "2º", "área": area3, "cargo": cargo3})
                    
                    else:
                        clicar_por_id(el_id)
                        area3, cargo3 = capturar_painel()
                        resultados.append({"órgão": orgao_atual, "escalão": "3º", "área": area3, "cargo": cargo3})
                i += 1
                continue
            ...
            if nivel == 4:
                if processando_ramo and is_orgao_tipo_a:
                    clicar_por_id(el_id)
                    area4, cargo4 = capturar_painel()
                    resultados.append({"órgão": orgao_atual, "escalão": "3º", "área": area4, "cargo": cargo4})
                i += 1
                continue
